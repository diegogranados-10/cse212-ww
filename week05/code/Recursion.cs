...
public static class Recursion
{
    ...
    {
        // Base case: if the word has reached the desired size, add it to results
        if (word.Length == size)
        {
            results.Add(word);
            return;
        ...
        // Recursive case: try adding each available letter to the current word
    ...
    {
        // Initialize the memoization dictionary if it doesn't exist
        if (remember == null)
        ...
        // Solve using recursion (pass the remember dictionary to recursive calls)
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        // Base case: no wildcards found, add the pattern to results
        if (wildcardIndex == -1)
        {
            results.Add(pattern);
            return;
        ...
        // Create two new patterns by replacing the wildcard with 0 and 1
        ...
        // Recursively process both patterns
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        {
            // Recursively try all four directions: right, down, left, up
        ...
        // Backtrack: remove current position from path to try other routes
