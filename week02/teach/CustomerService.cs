...
public class CustomerService {
    public static void Run() {
        ...
        // Defect(s) Found: ServeCustomer should get the customer before deleting from the list
        ...
        service = new CustomerService(4);
        service.ServeCustomer();
        // Defect(s) Found: Need to check the queue length in ServeCustomer and display an error message

        Console.WriteLine("=================");

        // Test 4
        // Scenario: Does the max queue size get enforced?
        // Expected Result: This should display some error message when the 5th one is added (max size is 4)
        ...
        // Defect(s) Found: Need to use >= instead of > in AddNewCustomer

        Console.WriteLine("=================");

        // Test 5
        // Scenario: Does the max size get defaulted to 10 if an invalid value is provided?
        // Expected Result: It should display max_size=10
